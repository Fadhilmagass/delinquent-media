            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="bg-white dark:bg-slate-800 shadow-md rounded-xl">
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            <label for="title"
                                class="block text-sm font-medium text-gray-700 dark:text-slate-300">Judul</label>
                            <x-text-input type="text" id="title" wire:model.blur="title" class="mt-1 block w-full"
                        ...
                        <div>
                            <label for="excerpt"
                                class="block text-sm font-medium text-gray-700 dark:text-slate-300">Kutipan
                                (Excerpt)</label>
                        ...
                        <div>
                            <label for="body"
                                class="block text-sm font-medium text-gray-700 dark:text-slate-300">Isi Artikel</label>
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="bg-white dark:bg-slate-800 shadow-md rounded-xl">
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            <label for="category"
                                class="block text-sm font-medium text-gray-700 dark:text-slate-300">Kategori</label>
                        ...
                        <div>
                            <label for="status"
                                class="block text-sm font-medium text-gray-700 dark:text-slate-300">Status</label>
                        ...
                        <div wire:ignore x-data="{
                            ...
                            <label for="tags"
                                class="block text-sm font-medium text-gray-700 dark:text-slate-300">Tags</label>
